...
/* ci configuration */
String sonarqubeProjectKey = 'edu.ie3:OSMoGrid' // sonarqube project key, case-sensitive
String codeCovTokenId = 'osmogrid-codecov-token' // id that matches the code coverage token set as jenkins property
